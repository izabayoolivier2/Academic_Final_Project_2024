      ...
      <div className="flex items-start space-x-4 sm:space-x-6">
        ...
        <div className="flex-1">
          ...
          <div className={`mt-6 mb-4 ${active ? "block" : "hidden"}`}>
            ...
            <ul className="mt-3.5 text-sm text-slate-500 dark:text-darkGray4 space-y-2">
              <li>
      ...
      <div className="border border-slate-200 dark:border-primary-buttonPrimary rounded-xl ">
        <div className="p-6 flex flex-col sm:flex-row items-start">
          ...
          <div className="sm:mr-8">
            <h3 className=" text-slate-700 dark:text-neutral-200 flex ">
              ...
              <svg
                ...
                strokeWidth="2.5"
                stroke="currentColor"
                className="w-5 h-5 mr-3 text-neutral-200"
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <div className="font-semibold mt-1 text-sm dark:text-darkGray4">
              <span className="">Google / Apple Wallet</span>
              <span className="ml-3">xxx-xxx-xx55</span>
            </div>
          </div>
          <button
            className="py-2 px-4 bg-slate-50 hover:bg-slate-100 dark:bg-ringColor dark:hover:bg-slate-700 mt-5 sm:mt-0 sm:mr-auto text-sm font-medium rounded-lg"
        ...
        <div
          className={`border-t border-slate-200 dark:border-primary-buttonPrimary px-6 py-7 space-y-6 ${isActive ? "block" : "hidden"
            }`}
        >
          {/* ==================== */}
