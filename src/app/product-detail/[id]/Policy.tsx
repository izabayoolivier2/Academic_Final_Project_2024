...
const A_FEATURES = [
  {
    ...
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="#ffc700" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="#50cd89" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="#d9214e" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    svg: `<svg width="24" height="24" viewBox="0 0 24 24" fill="#7239ea" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 relative">
      {A_FEATURES.map((item, index) => {
        return (
          <div
            key={index}
            className={`flex items-center p-5 rounded-2xl ${item.color}`}
          >
            <div dangerouslySetInnerHTML={{ __html: item.svg }}></div>
            <div className="mr-6">
              <p className="font-semibold text-white dark:text-gray-800">{item.name}</p>
              <p className="text-slate-500 dark:text-typoSecondaryColor mt-0.5 text-sm">{item.desc}</p>
            </div>
          </div>
        );
      })}
