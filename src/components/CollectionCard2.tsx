    ...
    <div className={`CollectionCard2 group relative ${className}`}>
      ...
      <div className="relative mt-5 flex justify-between">
        ...
        <div className="flex-1">
          ...
          {/* AUTHOR */}
          <Reveal>
            <div className="mt-3 flex items-center text-slate-500 dark:text-darkGray4">
              ...
              <span className="text-sm ml-1 ">
                <span className="line-clamp-1">5.0 (269 reviews)</span>
              </span>
            </div>
          </Reveal>
        </div>
      ...
      <Link href={"#-2"} className="absolute inset-0 "></Link>
    </div>
  );
};
