    ...
    return (
      <Popover className="relative">
        {({ open, close }) => (
          <>
            <Popover.Button
              className={`ml-3 flex items-center justify-center px-4 py-2 text-sm rounded-full border border-primary-500 bg-primary-50 text-primary-900 focus:outline-none `}
            >
              <svg
                className="w-4 h-4"
                viewBox="0 0 24 24"
              ...
              <span className="mr-2 min-w-[90px]">{`${rangePrices[0]} ر.س - ${rangePrices[1]} ر.س`}</span>
