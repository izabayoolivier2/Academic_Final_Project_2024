...
const DiscoverMoreSlider = () => {
  ...
  return (
    <div
      ref={sliderRef}
      dir="rtl"
      className={`nc-DiscoverMoreSlider nc-p-r-container ${isShow ? "" : "invisible"
        }`}
    >
      <Heading
        className="mb-12 text-sm lg:mb-14 text-neutral-900 dark:text-neutral-50 nc-p-l-container"
        desc=""
