  ...
  const renderLabel = () => {
    return (
      <div className="flex flex-col">
        <span className="font-medium text-neutral-800 dark:text-typoPrimaryColor">
          {label}
        </span>
        {desc && (
    ...
    >
      ...
      >
        <button
          ...
          disabled={min >= value}
        >
          <MinusIcon className="w-4 h-4 dark:text-typoPrimaryColor" />
        </button>
        <span className="select-none block flex-1 text-center leading-none dark:text-typoPrimaryColor">
          {value}
        </span>
        <button
          className="w-8 h-8 rounded-full flex items-center justify-center border border-neutral-400 dark:border-neutral-500 bg-white dark:bg-neutral-900 focus:outline-none hover:border-neutral-700 dark:hover:border-neutral-400 disabled:hover:border-neutral-400 dark:disabled:hover:border-neutral-500 disabled:opacity-50 disabled:cursor-default"
        ...
        >
          <PlusIcon className="w-4 h-4 dark:text-typoPrimaryColor" />
        </button>
      </div>
    </div>
  );
